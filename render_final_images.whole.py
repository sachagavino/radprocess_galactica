...
def create_imaging_cmd_file(config: dict, output_num: int, n_dust: int, view_name: str, view_details: dict):
    ...
    image_output_path = os.path.join(output_base_path, f'whole/{view_name}/')
    ...
    cmd_filename = f'{base_filename}.whole.cmd'
...
def main():
    ...
    try:
        ...
        for view_name, view_details in views_to_render.items():
            ...
            log_filepath = os.path.join(output_base_path, f'{base_filename}.whole.log')
